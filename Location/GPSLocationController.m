//
//  GPSLocationController.m
//  sq580.com.user
//
//  Created by hjw119 on 2017/2/24.
...
@interface GPSLocationController ()
...
+ (CLLocation*)getLocation {
    CLLocation* retLocation = [GPSLocationController sharedInstance].location;
    if (!retLocation) {
        //尝试从配置缓存读取
...
+ (NSString*)getLocationCity {
    NSString* city = [GPSLocationController sharedInstance].locationCity;
    if (!city) {
        //尝试从配置缓存读取
